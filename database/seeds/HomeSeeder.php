    ...
    public function run()
    {
        ...
        \Illuminate\Support\Facades\DB::table('homes')->insert([
            ...
            [
                ...
                'image' => 'https://my-pt.online/wp-content/uploads/2017/11/coms.jpg',
                'status' => '1',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s')
            ],
            [
                ...
                'image' => 'https://my-pt.online/wp-content/uploads/2017/11/communication.jpg',
                'status' => '1',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s')
            ],
            [
                ...
                'image' => 'https://my-pt.online/wp-content/uploads/2017/11/traing.jpg',
                'status' => '1',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s')
            ],
