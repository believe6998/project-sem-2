...
@section('content')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header text-center"><h2 class="mt-2 font-weight-bold">DANH SÁCH THỜI HẠN ĐÃ XÓA</h2></div>
            <div class="card-body card-hd-list-category">
                <div class="row">
                    <div class="col-6">
                        <h5 class="mb-1  text-primary mt-2 "><a href="/admin/duration"><i class="fas fa-bars"></i> Danh sách thời hạn</a></h5>
