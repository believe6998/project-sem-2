...
<script type="text/javascript">
    ...
    function drawPieChart(chart_data) {
        ...
        if(percentage1<=20){
            $('.advice-content-best-seller').html('<span>The <a href="'+'/admin/orders?personal_training_id='+ chart_data[0].product.id+'">'+chart_data[0].product.name+'</a> is doing great but compared with all its percentage overall is not too big</span>');
        } else if (percentage1<50 && percentage1>20) {
            $('.advice-content-best-seller').html('<span>The <a href="'+'/admin/orders?personal_training_id='+ chart_data[0].product.id+'">'+chart_data[0].product.name+'</a> is doing so great this time that you should think of importing more of it</span>');
        } else if (percentage1<=50) {
            $('.advice-content-best-seller').html('<span>The <a href="'+'/admin/orders?personal_training_id='+ chart_data[0].product.id+'">'+chart_data[0].product.name+'</a> takes more than half of your sales, you should not only import more of it but also promoting other products too. Such as <a href="'+'/admin/order?product_id='+ chart_data[1].product_id+'">'+chart_data[1].product.name+'</span>');
        }
