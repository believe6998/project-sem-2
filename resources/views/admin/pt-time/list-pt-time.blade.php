...
@section('content')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header text-center"><h2 class="mt-2 font-weight-bold">DANH SÁCH THỜI GIAN PT</h2></div>
            <div class="card-body card-hd-list-category">
                <div class="row">
                    <div class="col-6">
                        <h5 class="mb-1  text-primary mt-2 "><a href="/admin/pt-time/create-pt-time"><i class="far fa-plus-square"></i> Thêm mới</a></h5>

                    </div>
                    <div class="col-6">
                        <h5 class="mb-1  text-primary mt-2 d-flex justify-content-end"><a href="/admin/deleted-pt-time">
                                <i class="far fa-trash-alt"></i> Thời gian PT đã xóa</a></h5>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($lists as $item)
                            <tr class="text-center user-tr-item-ad">
                                <th scope="row " class="item-pt-time-ad">
                                ...
                                <td class="item-user-ad">
                                    <div class="row">
                                        <div class="col-6 "><a href="{{route('pt-time.edit',$item->id)}}"
                                                               class="text-primary"><i class="fas fa-edit"></i></a>
                                        </div>

                                        <div class="col-6"><a class="btn-delete-pt-time text-danger"
                                                              href="javascript:void(0)"
                                                              id="btn-delete-pt-time{{$item->id}}"><i
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-9">
                        <div class="form-group btn-choice-cate" id="select-action">
                            <button type="button" class="btn btn-outline-primary  " id="btn-apply-all-pt-time">Xác nhận</button>
