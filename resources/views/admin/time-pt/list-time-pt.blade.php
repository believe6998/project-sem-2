    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body card-hd-list-category">
                <div class="row">
                    <div class="col-6">
                        <h5 class="mb-1  text-primary mt-2 "><a href="/admin/time-pt/create"><i class="far fa-plus-square"></i> Thêm mới</a></h5>

                    </div>
                    <div class="col-6">
                        <h5 class="mb-1  text-primary mt-2 d-flex justify-content-end"><a href="/admin/deleted-time-pt">
                        ...
                        @foreach($time_pt as $item)
                            <tr class="text-center user-tr-item-ad">
                                ...
                                <td class="item-user-ad">
                                    <div class="row">
                                        <div class="col-6 "><a href="{{route('time-pt.edit',$item->id)}}"
                                                               class="text-primary"><i class="fas fa-edit"></i></a>
                                        </div>

                                        <div class="col-6"><a class="btn-delete-time-pt text-danger"
                                                              href="javascript:void(0)"
                                                              id="btn-delete-time-pt{{$item->id}}"><i
