                                ...
                                <div class="row d-flex justify-content-center mt-2">
                                    <div class="col-6 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" required autocomplete="phone" placeholder="Số điện thoại." name="phone">
                                        </div>
                                    </div>
                                    <div class="col-6 ">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-inline mt-2">
                                                <input class="form-check-input" required autocomplete="gender" type="radio" name="gender" id="inlineRadio1" value="0">
                                                <label class="form-check-label" for="inlineRadio1">Nam</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" required autocomplete="gender" type="radio" name="gender" id="inlineRadio2" value="1">
