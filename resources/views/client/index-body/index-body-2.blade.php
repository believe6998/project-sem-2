                ...
                <form action="/index-body-3" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" style="padding-right: 200px">
                            <input type="radio" name="sex_section" value="1" class="sex_section">
                            <i class="fas fa-male fa-3x" style="padding-right: 40px"></i>
                            <input type="radio" name="sex_section" value="0" class="sex_section">
                        ...
                        <div class="col-6" style="padding-right: 200px">
                            <input type="number" name="weight" class="input-mini-all">
                        ...
                        <div class="col-6" style="padding-right: 200px">
                            <input type="number" name="height" class="input-mini-all">
                        ...
                        <div class="col-6" style="padding-right: 250px">
                            <input type="number" name="age" class="input-mini-all">
                        </div>
                        <div class="form-text col-6" style="padding-left: 200px">
                            Mức Độ Luyện Tập
                        </div>
